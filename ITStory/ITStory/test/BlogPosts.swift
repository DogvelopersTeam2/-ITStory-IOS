...
//import Foundation
//
//struct BlogPosts : Codable { // Identifiable // Codable
//
//
//    init(postId: Int = 0, postTitle: String = "", postContent: String = "") {
//        self.postId = postId
...
//    init(id: Int = 0, name: String = "", image: String = "", details: String = "", postTitle: String = "", postContent: String = "") {
//        self.id = id
//        self.name = name
//        self.image = image
